  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-gray-100 flex flex-col items-center justify-center p-6">
      ...
      <p className="text-gray-600 mb-10 text-center max-w-md">
        Explore Egyptian artifacts - scan an image or search the collection
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-8 w-full max-w-3xl">
        ...
        >
          ...
          <p className="text-gray-600 text-center">
            Upload an image to identify an artifact and reveal its history
          </p>
        </Link>
        ...
        >
          ...
          <p className="text-gray-600 text-center">
            Search the museum database by name or keyword
          </p>
        </Link>
      </div>

      <footer className="mt-16 text-gray-400 text-sm text-center">
        {new Date().getFullYear()} AI Museum Guide
      </footer>
    </div>
  );
}
