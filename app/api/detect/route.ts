...
/*************  ✨ Windsurf Command ⭐  *************/
/**
 * Detect an artifact in an image using YOLO and retrieve its metadata using the museumAPI.
 *
 * @param {Request} req - The HTTP request object.
 *
 * @returns {Promise<NextResponse>} - A JSON response containing the detected artifact's ID, confidence, and metadata.
 *
 * @throws {Error} - If the detection or metadata retrieval fails.
 */
/*******  7b997690-4077-4730-97ed-b1af46cd9baa  *******/  console.log("🔍 === DETECTION REQUEST STARTED ===");
